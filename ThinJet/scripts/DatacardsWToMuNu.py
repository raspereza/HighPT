...
#     definition of cuts        #
#################################
basecut = 'pt_1>140&&fabs(eta_1)<2.1&&metfilter>0.5&&njets==0&&extraelec_veto<0.5&&extramuon_veto<0.5&&extratau_veto<0.5&&idMedium_1>0.5&&njets==0&&iso_1<0.15'
...
def PlotWToMuNu(h_data_input,h_bkg_input,h_sig_input,era,var):
    ...
    if era=='UL2016_preVFP':
        h_sig_input.SetBinContent(6,0.7*h_sig_input.GetBinContent(6))
        h_sig_input.SetBinError(6,0.5*h_sig_input.GetBinError(6))
...
if __name__ == "__main__":
    ...
    xbins = [300,400,500,600,700,800,1000,1200,1400]
    #    xbins = utils.createBins(args.nbins,args.xmin,args.xmax)
    basefolder = utils.picoFolderMuNu
    var = args.variable    
